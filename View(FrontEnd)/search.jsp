...
if(book_query == null || book_query.equals("null") ){
	book_query = "";
...
// if default option
if(genre_query.equals("Select genre") || genre_query == "null" || genre_query == null){
	genre_query = "";
}
else{
...
if(author_query == "null"  || author_query == "" || author_query == null){
	author_query = "";
}else{
