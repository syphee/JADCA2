		...
		<div class="row flex-nowrap ">
			...
			<main class="col-sm col border-start ps-md-2 pt-2">
				...
				<div id="arkCONTENT" class="accordion">
					...
					<!-- Add Book -->
					<!-- To add form here -->
					<div class="accordion-body accordion-collapse collapse border"
						id="addBook" data-bs-parent="#arkCONTENT">
						<div>
							<header>
								...
								<form action="<%= request.getContextPath()%>/addBook"
									...
									<div class="row my-5">
										...
										<div class="col">
											<input type="file" name="file" onChange="previewImage(event)"
												accept="image/*" /> <img
												src="<%= request.getContextPath()%>/assets/<%=URI%>"
									...
									<div class="row  my-5">
										...
										<div class="dropdown col">
											<div class="row mx-1">
												<select name="genre"
													class="btn btn-danger dropdown-toggle col-3">
					...
					<!-- Delete User -->
					<div class="row accordion-body accordion-collapse collapse"
						id="deleteUser" data-bs-parent="#arkCONTENT">
						<div>
							<header>
