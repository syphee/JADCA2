...
public class PaymentServices {
    ...
    private RedirectUrls getRedirectURLs() {
    	 RedirectUrls redirectUrls = new RedirectUrls();
    	    redirectUrls.setCancelUrl("http://localhost:8080/jadca2_jadca2/BookstoreCA1/JAD-CA1/View(FrontEnd)/checkout.jsp");
    	    redirectUrls.setReturnUrl("http://localhost:8080/jadca2_jadca2/ReviewPaymentServlet");
